...
void generateOperatorsList(){
	...
	ADD_OPERATOR_INTO_THE_LIST("DETAIL_DESCRIPTION");
	ADD_OPERATOR_INTO_THE_LIST("DETAIL_PROPERTIES");
	ADD_OPERATOR_INTO_THE_LIST("DETAIL_PROPERTY");
	ADD_OPERATOR_INTO_THE_LIST("PROPERTY_VALUE");
	...
	ADD_OPERATOR_INTO_THE_LIST("ARG_VECTOR_3D");
	ADD_OPERATOR_INTO_THE_LIST("ARG_QUATERNION_OPT");
	ADD_OPERATOR_INTO_THE_LIST("ARG_QUATERNION");
	...
	ADD_OPERATOR_INTO_THE_LIST("RBL_VAR_ELEMENTS");
	...
	ADD_OPERATOR_INTO_THE_CLOSURE_LIST("DETAIL_PROPERTIES");
	ADD_OPERATOR_INTO_THE_CLOSURE_LIST("PROPERTY_VALUE");
	...
	ADD_OPERATOR_INTO_THE_CLOSURE_LIST("RBL_VAR_ELEMENTS");
